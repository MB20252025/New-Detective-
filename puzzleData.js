...
var suspectsData = [
  {
    ...
    questions: [
      ...
      "Did you notice anyone unusual on the premises recently?",
      "Have you ever seen the victim acting strangely?",
      "What do you know about the security cameras?"
    ],
    responses: [
      ...
      "I saw a few new faces around the site, but I didn't think much of it at the time.",
      "Now that you mention it, he did seem worried the week before. Kept checking the locks.",
      "They cover the main halls, but there are blind spots near the back doors. Everyone knows that."
    ]
  },
  {
    id: "s2",
    ...
    questions: [
      ...
      "Who else had access to the security override codes?",
      "Was there any unusual activity in the system logs?",
      "Did the victim ever mention any threats to you?"
    ],
    responses: [
      ...
      "Just myself, the site manager, and the vendor. Standard protocol.",
      "There was a brief override at 2:17 AM — documented as a false alarm. Odd timing, though.",
      "He mentioned once he was worried about someone inside the company. He wouldn't say who."
    ]
  },
  {
    id: "s3",
    ...
    questions: [
      ...
      "Were you at any of the crime scenes that night?",
      "Do you have any disagreements with the victim?",
    ...
    responses: [
      ...
      "I was at the office until late, then went straight home. Nothing out of the ordinary.",
      "Nothing significant — just normal workplace matters. Nothing worth mentioning.",
      "The security logs should show my badge swipes. Or... actually, I don't remember exactly which door I used."
    ]
  }
];
