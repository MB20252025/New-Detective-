...
// ========== MAIN PUZZLES (all original) ==========
var mainPuzzlesData = [
  // 1. The Escape Route – restored to the map‑based version
  {
    id: "escape_route",
  ...
  // 2. Two Mischievous Watchers (unchanged)
  {
  ...
  // 3. Street of Shining Metal (unchanged)
  {
    id: "silver_street",
  ...
  // 4. The Chase Through Lincoln (unchanged)
  {
    id: "lincoln_museum",
  ...
  // 5. The Roar of the Crowd (unchanged)
  {
    id: "stadium_crowd",
  ...
  // 6. Defenders of the Castle (unchanged)
  {
    id: "castle_cannons",
  ...
  // 7. The Sword of Richard I (unchanged)
  {
    id: "sword_of_richard",
